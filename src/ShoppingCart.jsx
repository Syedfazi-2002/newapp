...
function Shopping(){
    ...
    return(
        <div class="d-flex flex-wrap">
            ...
            {
                products.map((a,i)=>{
                    return <div  class="card p-3 mb-5 rounded m-4 text-emphasis-info" style={{width: '14rem',backgroundColor:"#FFB190",boxShadow:"20px"}}>
            ...
            <div class='p-3'style={{width:'45%',border:'3px dashed green',position:"fixed",height:"100%",overflowY:"scroll",right:"30px"}}>
                ...
                cart.length>0 && cart.map((b,ind)=>{
                    return <div class="card justify-content-between" style={{backgroundColor:"#FFB190",marginBottom:"20px"}}>
